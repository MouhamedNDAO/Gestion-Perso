...
catch(Exception $e)
{
 ...
 $pdostatement = $bdd -> prepare ('INSERT INTO gestion VALUES(NULL,:prenom,:nom,:email,:adresse,:anniversaire,:fonction,:specialite,:sexe,:passe)');
 ...
 $pdostatement -> bindValue(':password',$_POST["password"],PDO::PARAM_STR);
